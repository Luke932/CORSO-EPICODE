...
if (productID) {
    ...
    form.addEventListener('submit', (e) => {
        ...
        fetch(url + productID, {
            ...
            headers: {
                Authorization: "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2NDVlMDZkODg4Zjc0MDAwMTQyODc0OTMiLCJpYXQiOjE2ODM4ODM3MzYsImV4cCI6MTY4NTA5MzMzNn0.colNDlBjkI-AldE82lkGMXSi_VS66ImoqC0S_c1Eth0",
...
//! METODI POST & PUT FATTI CON OPERATORIO TERNARIO PIUTTOSTO CHE SINGOLARMENTE
